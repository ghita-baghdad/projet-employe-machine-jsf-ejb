...
private List<Machine> filteredMachines;
    ...
    // In MachineController class
    public String getSelectedLocale() {
        // Implement logic to get the selected locale
        return yourBean.getSelectedLocale();
    }

// public List<Machine> getFilteredMachines() {
//    if (selectedEmploye != null) {
//        System.out.println("Selected Employe: " + selectedEmploye.getId()); // Add this line for debugging
//        // Fetch machines for the selected employee
//        List<Machine> filteredMachines = ejbFacade.findByEmployee(selectedEmploye);
//        System.out.println("Filtered Machines: " + filteredMachines.size()); // Add this line for debugging
//        return filteredMachines;
//    } else {
//        // If no employee is selected, return all machines
//        return items;
//    }
//}
    public ChartModel initBarModel() {
        ...
        for (Map.Entry<String, Integer> entry : machinesCountByYear.entrySet()) {
